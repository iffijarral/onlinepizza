...
export const CategoriesTable = (props) => {
    ...
    }, [props.dialogState, open, confirmationOpen]);
    ...
    return (
        <React.Fragment>
            ...
            <NewCategoryDialog ref={childRef} open={open} categories={rows[currentIndex]} handleClose={handleClose} />
            <ConfirmationDialog open={confirmationOpen} type='category' category={rows[currentIndex]} handleDelete={handleDelete} handleClose={handleConfirmationClose} />
